document.addEventListener('DOMContentLoaded', () => {
    ...
    const personajes = [
        { nombre: "Naruto", info: "crece como huérfano y rechazado por tener al zorro de nueve colas sellado en su interior, lucha por ganarse el respeto de todos.", transformaciones: 6 },
